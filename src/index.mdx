...
- **Route** The way R.A.D. is accessed via your/the communities routes. Via the R.A.D. Routes Runner, which contacts our servers API to pull your created route from the R.A.D. cloud, and run them on your machine.
